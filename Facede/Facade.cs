...
namespace Facede
{
    public class Facade
    {
        ...
        {
            return DACConsulta.DatosCensoAseguramiento(regional, unis, ciudad);
        }
        ...
        {
            return DACConsulta.TraerRegistroAHDetalle(idDetalle);
        }
        ...
        public int ActualizarEstadoRegistroAH(int? idRegistro, int? estado)
        {
            return DACActualiza.ActualizarEstadoRegistroAH(idRegistro, estado);
        }

        public int ActualizarDetalleAHGestion(cargue_censo_ah_registros_detalle det)
        {
    ...
    string documentoPaciente, int? idConcurrencia, DateTime? fechaIngresoIni, DateTime? fechaIngresoFin, int? conEgreso)
     ...
     string dxDesA, string relDxA, string relDxDesA)
        ...
        {
            return DACConsulta.TraerDatosFacturaIdFac(idFac);
        }

        public int GuardarLoteEnvioFacturasPedido(fis_envioFactura_pedido_lote obj, List<fis_envioFactura_pedido_registros> listado)
        {
            return DACInserta.GuardarLoteEnvioFacturasPedido(obj, listado);
        }

        public int ActualizaEstadoPedidoFactura(int? idLote)
        {
            return DACActualiza.ActualizaEstadoPedidoFactura(idLote);
        }

        public int ActualizaEstadoPedidoFacturaIdAf(int? idFac)
        {
            return DACActualiza.ActualizaEstadoPedidoFacturaIdAf(idFac);
        }

        public List<management_rips_af_cargue_dtll_loteResult> TraerIdsFacturasIdLote(int? idLote)
        {
            return DACConsulta.TraerIdsFacturasIdLote(idLote);
        }

        public List<fis_rips_cargue_registrosCompletos> TraerDetallesFacturaId(int? idFactura)
        {
            return DACConsulta.TraerDetallesFacturaId(idFactura);
        }

        public List<management_fis_inexistenciaBeneficiarioIdFacturaResult> TraerInextistenciaBeneficiarioFIS(int? idFactura)
        {
            return DACConsulta.TraerInextistenciaBeneficiarioFIS(idFactura);
        }

        public List<management_fis_API_TableroErroresBAPIHESResult> ListadoErroresEnvioHES(DateTime? fechaInicio, DateTime? fechaFin)
        {
            return DACConsulta.ListadoErroresEnvioHES(fechaInicio, fechaFin);
        }

        public List<management_fis_facturasCuv_conBeneficiarios_tarifasErradasResult> ListadoTarifasErradasFIS(int? idFactura)
        {
            return DACConsulta.ListadoTarifasErradasFIS(idFactura);
        }

        public List<management_fis_validacionExistenCupsResult> ListadoCupsInexistentesIdFactura(int? idFactura)
        {
            return DACConsulta.ListadoCupsInexistentesIdFactura(idFactura);
        }
        ...
        public int GuardarRecomendacionAuditoria(creacion_recomendaciones_auditoria obj)
        {
            return DACInserta.GuardarRecomendacionAuditoria(obj);
        }

        public int ActualizarRecomendacionAuditoriaId(creacion_recomendaciones_auditoria obj)
        {
            return DACActualiza.ActualizarRecomendacionAuditoriaId(obj);
        }

        public creacion_recomendaciones_auditoria TraerRecomendacionAuditoriaId(int? idRecomendacion)
        {
            return DACConsulta.TraerRecomendacionAuditoriaId(idRecomendacion);
        }

        public List<ref_recomendaciones_tipoFiltrado> ListaRecomendacionTipoFiltrado()
        {
            return DACConsulta.ListaRecomendacionTipoFiltrado();
        }

        public List<ref_recomendaciones_tipoCodificacion> ListaRecomendacionTipoCodificacion()
        {
            return DACConsulta.ListaRecomendacionTipoCodificacion();
        }

        public List<ref_recomendaciones_tipoRecomendacion> ListaRecomendacionTipoRecomendacion()
        {
            return DACConsulta.ListaRecomendacionTipoRecomendacion();
        }

        public List<management_recomendacion_tableroControlResult> ListadoTableroRecomendaciones()
        {
            return DACConsulta.ListadoTableroRecomendaciones();
        }

        public int EliminarRecomendacionAuditoria(int? idRecomendacion)
        {
            return DACElimina.EliminarRecomendacionAuditoria(idRecomendacion);
        }

        public int ActualizarEstadoRecomendacionAuditoriaId(int? idRecomendacion, int? estado)
        {
            return DACActualiza.ActualizarEstadoRecomendacionAuditoriaId(idRecomendacion, estado);
        }
