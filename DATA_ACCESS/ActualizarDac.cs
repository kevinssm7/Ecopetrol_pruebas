    ...
    public class ActualizarDac
    {
        ...
        public int ActualizarDetalleAHGestion(cargue_censo_ah_registros_detalle det)
        {
            try
            {
                using (ECOPETROL_DataContexDataContext db = new ECOPETROL_DataContexDataContext())
                {
                    cargue_censo_ah_registros_detalle obj = db.cargue_censo_ah_registros_detalle.FirstOrDefault(x => x.id_detalle == det.id_detalle);
                    obj.hospitalizacion = det.hospitalizacion;
                    obj.hospitalizacion_no_observacion = det.hospitalizacion_no_observacion;
                    obj.corte_facturacion = det.corte_facturacion;
                    obj.tipo_habitacion = det.tipo_habitacion;
                    obj.medico_auditor = det.medico_auditor;
                    obj.linea_pago = det.linea_pago;
                    obj.cie10 = det.cie10;
            ...
            try
            {
                using (ECOPETROL_DataContexDataContext db = new ECOPETROL_DataContexDataContext())
                {
                    ...
                    else if (ObjPqrs.estado_gestion == 7)
                    {
                        ...
                        //ObjAuditada.plan_de_mejora = ObjPqrs.plan_de_mejora;
                        //ObjAuditada.observacion_plan_mejora = ObjPqrs.observacion_plan_mejora;
                    }
                    ...
                    ObjAudit.requiere_plan_mejora = ObjPqrs.plan_de_mejora;
                    ObjAudit.observacion_plan_mejora = ObjPqrs.observacion_plan_mejora;
        ...
        public int ActualizaEstadoPedidoFactura(int? idLote)
        {
            try
            {
                using (ECOPETROL_DataContexDataContext db = new ECOPETROL_DataContexDataContext())
                {
                    db.management_fis_actualizaEstadoFactur_solicitudPedido(idLote);
                    return 1;
                }
            }
            catch (Exception ex)
        ...
        public int ActualizaEstadoPedidoFacturaIdAf(int? idFac)
        {
            try
            {
                using (ECOPETROL_DataContexDataContext db = new ECOPETROL_DataContexDataContext())
                {
                    db.management_fis_actualizaEstadoFactur_solicitudPedido_idAF(idFac);
                    return 1;
                }
            }
            catch (Exception ex)
        ...
        public int ActualizarEstadoRegistroAH(int? idRegistro, int? estado)
        {
            try
            {
                using (ECOPETROL_DataContexDataContext db = new ECOPETROL_DataContexDataContext())
                {
                    cargue_censo_ah_registros reg = db.cargue_censo_ah_registros.FirstOrDefault(x => x.id_registro == idRegistro);
                    reg.estado = estado;
                    db.SubmitChanges();
                    return 1;
                }
        ...
        public int ActualizarRecomendacionAuditoriaId(creacion_recomendaciones_auditoria obj)
        {
            try
            {
                using (ECOPETROL_DataContexDataContext db = new ECOPETROL_DataContexDataContext())
                {
                    creacion_recomendaciones_auditoria act = db.creacion_recomendaciones_auditoria.FirstOrDefault(x => x.id_recomendacion == obj.id_recomendacion);
                    act.tipo_filtrado = obj.tipo_filtrado;
                    act.tipo_codificacion = obj.tipo_codificacion;
                    act.cups = obj.cups;
                    act.diagnostico = obj.diagnostico;
                    act.tipo_edad = obj.tipo_edad;
                    act.edad = obj.edad;
                    act.tipo_genero = obj.tipo_genero;
                    act.tipo_recomendacion = obj.tipo_recomendacion;
                    act.observaciones = obj.observaciones;
                    act.estado = obj.estado;
                    db.SubmitChanges();
                    return 1;
                }
            }
        ...
        public int ActualizarEstadoRecomendacionAuditoriaId(int? idRecomendacion, int? estado)
        {
            try
            {
                using (ECOPETROL_DataContexDataContext db = new ECOPETROL_DataContexDataContext())
                {
                    creacion_recomendaciones_auditoria act = db.creacion_recomendaciones_auditoria.FirstOrDefault(x => x.id_recomendacion == idRecomendacion);
                    act.estado = estado;
                    db.SubmitChanges();
                    return 1;
                }
