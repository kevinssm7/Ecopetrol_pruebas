    ...
    public class CUPSUNICOS
    {
        ...
        public fis_rips_cargue_transaccion ValidarEstructuraTransaccion(JObject TransaE, string numFactura, string codPrestador)
        {
            ...
            try
            {
                ...
                {
                    mensajeResultadoLocal = "No se proporcionó un archivo o el archivo está vacío.";
                }
            }
            catch (Exception ex)
            {
                var error = ex.Message.Contains("Error reading JObject from JsonReader.") ? "El archivo JSON tiene estructura erronea" : ex.Message;
                mensajeResultadoLocal = "Error al procesar el archivo: " + error;
            }

            mensajeResultado = mensajeResultadoLocal;
            return dato;
        }
        ...
        public fis_rips_cargue_medicamentos ValidarEstructuraMedicamento(JObject MedicamentoE, string codPrestador, List<fis_rips_cups> listadoCups, int? fila)
        {
            ...
            try
            {
                ...
                {
                    if (ex.Message.Contains("no puede ir vacío"))
                    {
                        textError = ex.Message;
                    }
                    else
        ...
        public fis_rips_cargue_otros_servicios ValidarEstructuraOtroServicio(JObject OtroServicioE, string codPrestador, List<fis_rips_cups> listadoCups, int? fila)
        {
            string columna = "";
            var textError = "";
            fis_rips_cargue_otros_servicios dato = new fis_rips_cargue_otros_servicios();
            ...
            try
            {
                    ...
                    foreach (DataRow item in dt2.Rows)
                    {
                        ...
                        if (!string.IsNullOrEmpty(item["ID_detalle"].ToString()))
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    mensajeLog += $"<br/> Fila: {fila} - columna: {columna} No puede ir vacio.";
                                }
                            }
                            catch (Exception ex)
                            {
                                var error = ex.Message;
                                mensajeLog += $"<br/> Fila: {fila} - columna: {columna} {error}";
                            }
                            ...
                            try
                            {
                                ...
                                if (datoPrueba != null)
                                {
                                    ...
                                    if (!string.IsNullOrEmpty(fechaTexto))
                                    {
                                        ...
                                        {
                                            mensajeLog += $"<br/> Fila: {fila} - columna: {columna} Formato incorrecto";
                                        }
                                    }
                                    else
                                    {
                                        mensajeLog += $"<br/> Fila: {fila} - columna: {columna} No puede venir vacío";
                                    }
                                }
                                else
                                {
                            ...
                            try
                            {
                                ...
                                if (!string.IsNullOrEmpty(texto))
                                {
                                    ...
                                    if (cups == null)
                                    {
                                        mensajeLog += $"<br/> Fila: {fila} - columna: {columna} Código homologado FIS no existe";
                                    }
                            ...
                            try
                            {
                                ...
                                if (!string.IsNullOrEmpty(texto))
                                {
                                    ...
                                    if (cie10 == null)
                                    {
                                        mensajeLog += $"<br/> Fila: {fila} - columna: {columna} Código del diagnóstico principal no existe";
                                    }
                                }
                                else
                                {
                            ...
                            try
                            {
                                ...
                                if (!string.IsNullOrEmpty(texto))
                                {
                                    ...
                                    {
                                        mensajeLog += $"<br/> Fila: {fila} - columna: {columna} La cantidad debe ser mayor a 0";
                                    }
                                }
                                else
                                {
                            ...
                            try
                            {
                                ...
                                if (!string.IsNullOrEmpty(texto))
                                {
                                    ...
                                    {
                                        mensajeLog += $"<br/> Fila: {fila} - columna: {columna} El valor unitario debe ser mayor a 0";
                                    }
                                }
                                else
                                {
                            ...
                            try
                            {
                                ...
                                if (!string.IsNullOrEmpty(texto))
                                {
                                    ...
                                    {
                                        mensajeLog += $"<br/> Fila: {fila} - columna: {columna} El valor neto debe ser mayor a 0";
                                    }
                                }
                                else
                                {
                ...
                catch (Exception ex)
                {
                    ...
                    else
                    {
                        if (textError != "" && textError != null)
                        {
                            MsgRes.DescriptionResponse = textError;
                        }
                        else
                        {
                            MsgRes.DescriptionResponse = ex.Message;
