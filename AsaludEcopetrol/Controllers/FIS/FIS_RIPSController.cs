...
namespace AsaludEcopetrol.Controllers.FIS
{
    public class FIS_RIPSController : Controller
    {
                                ...
                                else if (tipo == 3)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            foreach (var item in idList)
                                            {
                                                Models.EnvioCambioEstadoEcopetrol(item, "Cambio estado a aceptada");
                                            }
                                        }
                                    }
                                }
        ...
        public string InsercionDatosJson(JObject DatosTransaccion, fis_rips_cargue_LoteConsultas lote, string codPrestador)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(mensaje))
                {
                            ...
                            foreach (var usuario in usuarios)
                            {
                                ...
                                if (string.IsNullOrEmpty(mensaje))
                                {
                                    ...
                                    if (insercionUsuario != 0)
                                    {
                                                ...
                                                if (registrosServicioArray != null)
                                                {
                                                    foreach (JObject registrosServicio in registrosServicioArray)
                                                    {
                                                        ...
                                                        if (tipoDatoArray == "consultas")
                                                        {
                                                            ...
                                                            if (string.IsNullOrEmpty(Model.mensajeResultado))
                                                            {
                                                                if (cons != null)
                                                                {
                                                                    ...
                                                                    {
                                                                        retorno += $"ERROR EN INSERCIÓN DATOS CONSULTA: Fila {filaServicios}";
                                                                    }
                                                                }
                                                            }
                                                            else
                                                            {
                                                                retorno += $"<br/> {Model.mensajeResultado}";
                                                            }
                                                        }
                                                        ...
                                                        else if (tipoDatoArray == "hospitalizacion")
                                                        {
                                                            ...
                                                            if (string.IsNullOrEmpty(Model.mensajeResultado))
                                                            {
                                                                if (hospi != null)
                                                                {
                                                                    ...
                                                                    {
                                                                        retorno += $"ERROR EN INSERCIÓN DATOS HOSPITALIZACIÓN: Fila {filaServicios}";
                                                                    }
                                                                }
                                                            }
                                                            else
                                                        ...
                                                        else if (tipoDatoArray == "procedimientos")
                                                        {
                                                            ...
                                                            if (string.IsNullOrEmpty(Model.mensajeResultado))
                                                            {
                                                                if (proce != null)
                                                                {
                                                                    ...
                                                                    {
                                                                        retorno += $"ERROR EN INSERCIÓN DATOS PROCEDIMIENTOS: Fila {filaServicios}";
                                                                    }
                                                                }
                                                            }
                                                            else
                                                        ...
                                                        else if (tipoDatoArray == "urgencias")
                                                        {
                                                            ...
                                                            if (string.IsNullOrEmpty(Model.mensajeResultado))
                                                            {
                                                                if (urge != null)
                                                                {
                                                                    ...
                                                                    {
                                                                        retorno += $"ERROR EN INSERCIÓN DATOS URGENCIAS: Fila {filaServicios}";
                                                                    }
                                                                }
                                                            }
                                                            else
                                                        ...
                                                        else if (tipoDatoArray == "recienNacidos")
                                                        {
                                                            ...
                                                            if (string.IsNullOrEmpty(Model.mensajeResultado))
                                                            {
                                                                if (recien != null)
                                                                {
                                                                    ...
                                                                    {
                                                                        retorno += $"ERROR EN INSERCIÓN DATOS RECIEN NACIDO: Fila {filaServicios}";
                                                                    }
                                                                }
                                                            }
                                                            else
                                                        ...
                                                        else if (tipoDatoArray == "medicamentos")
                                                        {
                                                            ...
                                                            if (string.IsNullOrEmpty(Model.mensajeResultado))
                                                            {
                                                                if (medi != null)
                                                                {
                                                                    ...
                                                                    {
                                                                        retorno += $"ERROR EN INSERCIÓN DATOS MEDICAMENTOS: Fila {filaServicios}";
                                                                    }
                                                                }
                                                            }
                                                            else
                                                        ...
                                                        {
                                                            fis_rips_cargue_otros_servicios otro = Model.ValidarEstructuraOtroServicio((JObject)registrosServicio, codPrestador, listadoCups, filaServicios);
                                                            if (string.IsNullOrEmpty(Model.mensajeResultado))
                                                            {
                                                                if (otro != null)
                                                                {
                                                                    ...
                                                                    {
                                                                        retorno += $"ERROR EN INSERCIÓN DATOS OTROS SERVICIOS: Fila {filaServicios}";
                                                                    }
                                                                }
                                                            }
                                                            else
                                        ...
                                        {
                                            retorno += $"EL USUARIO {usu.numDocumentoIdentificacion} NO TIENE SERVICIOS";
                                        }
                                    ...
                                    {
                                        retorno += $"ERROR EN INSERCIÓN DATOS USUARIO: {Model.mensajeResultado}";
                                    }
                                }
                                else
                                {
                                    retorno += $"ERROR EN VALIDACIÓN DATOS USUARIO: {Model.mensajeResultado}";
                                }
                            }
                        }
                    }
                    ...
                    {
                        retorno += $"ERROR EN INSERCIÓN DATOS TRANSACCIÓN: {Model.mensajeResultado}";
                    }
                ...
                {
                    retorno += $"ERROR EN VALIDACIÓN DATOS TRANSACCIÓN: {Model.mensajeResultado}";
                }
        ...
        public ActionResult CreacionecomendacionesAuditoria(int? idRecomendacion)
        {

            creacion_recomendaciones_auditoria obj = new creacion_recomendaciones_auditoria();
            if (idRecomendacion != null && idRecomendacion != 0)
            {
                obj = BusClass.TraerRecomendacionAuditoriaId(idRecomendacion);
            }

            ViewBag.idRecomendacion = idRecomendacion;

            ViewBag.tipoFiltrado = BusClass.ListaRecomendacionTipoFiltrado();
            ViewBag.tipoCodificacion = BusClass.ListaRecomendacionTipoCodificacion();
            ViewBag.tipoRecomendacion = BusClass.ListaRecomendacionTipoRecomendacion();

            return View(obj);
        }

        public JsonResult GuardarRecomendaciones(int? idRecomendacion, int? tipoFiltrado, int? tipoCodificacion, string cups,
            string diagnostico, string tipoEdad, int? edad, string tipoGenero, int? tipoRecomendacion, string observaciones)
        {
            var rta = 0;
            var mensaje = "";
            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(cups))
                {
                    fis_rips_cups objCups = BusClass.TraerCupsCodigo(cups);
                    if (objCups == null)
                    {
                        throw new Exception("No existe este código CUPS");
                    }
                }

                if (!String.IsNullOrEmpty(diagnostico))
                {
                    ref_cie10_fis objCups = BusClass.TraerCie10Codigo(diagnostico);
                    if (objCups == null)
                    {
                        throw new Exception("No existe este código CIE10");
                    }
                }

                obj.tipo_filtrado = tipoFiltrado;
                obj.tipo_codificacion = tipoCodificacion;
                obj.cups = cups;
                obj.diagnostico = diagnostico;
                obj.tipo_edad = tipoEdad;
                obj.edad = edad;
                obj.tipo_genero = tipoGenero;
                obj.tipo_recomendacion = tipoRecomendacion;
                obj.observaciones = observaciones;
                obj.estado = 1;
                obj.fecha_digita = DateTime.Now;
                obj.usuario_digita = SesionVar.UserName;

                if (idRecomendacion != 0 && idRecomendacion != null)
                {
                    obj.id_recomendacion = (int)idRecomendacion;
                    idGestion = BusClass.ActualizarRecomendacionAuditoriaId(obj);
                }
                else
                {
                    idGestion = BusClass.GuardarRecomendacionAuditoria(obj);
                }

                if (idGestion != 0)
                {
                    mensaje = "RECOMENDACIÓN GESTIONADA CORRECTAMENTE";
                    rta = 1;
                }
                else
                {
                    mensaje = "ERROR EN LA GESTIÓN DE RECOMENDACIÓN";
                }
            }
            catch (Exception ex)
            {
        ...
        public ActionResult TableroRecomendaciones()
        {
            List<management_recomendacion_tableroControlResult> listadoRecomendaciones = new List<management_recomendacion_tableroControlResult>();
            try
            {
                listadoRecomendaciones = BusClass.ListadoTableroRecomendaciones();
            }
            catch (Exception ex)
            {
                var error = ex.Message;
            ...
            ViewBag.listado = listadoRecomendaciones;
            ViewBag.conteo = listadoRecomendaciones.Count();

            return View();
        }

        public JsonResult EliminarRecomendacion(int? idRecomendacion)
        {
            var mensaje = "";
            var rta = 0;
            try
            {
                var elimina = BusClass.EliminarRecomendacionAuditoria(idRecomendacion);
                if (elimina != 0)
                {
        ...
        public JsonResult EditarEstadoRecomendacion(int? idRecomendacion, int? estado)
        {
            var mensaje = "";
            var rta = 0;
            try
            {
                int? estadoActualiza = estado == 1 ? 0 : 1;

                var actualiza = BusClass.ActualizarEstadoRecomendacionAuditoriaId(idRecomendacion, estadoActualiza);
                if (actualiza != 0)
                {
                    mensaje = "ESTADO RECOMENDACIÓN ACTUALIZADO CORRECTAMENTE";
                    rta = 1;
                }
                else
                {
                    mensaje = "ERROR AL ACTUALIZAR ESTADO RECOMENDACIÓN";
                }
            }
            catch (Exception ex)
            {
