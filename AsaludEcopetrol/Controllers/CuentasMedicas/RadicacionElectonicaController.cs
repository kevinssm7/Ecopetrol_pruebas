        ...
        public StringBuilder TraerDetalleIndividualCups(int? idRegistro, int? idFactura, int? tipoPintada)
        {
            ...
            try
            {
                ...
                if (registro != null)
                {
                    ...
                    if (registro.alertaCups == 0)
                    {
                        resultado.AppendLine($"<i class=\"alerta_historico glyphicon glyphicon-warning-sign\" title=\"Procedimiento ya reconocido en factura {registro.facturaReconocid} - Verificar histórico, evolución médica y motivo de los procedimientos\"></i>");
                    }
                    ...
                    if (tipoPintada == 2)
                    {
                        if (registro.alertaCups == 0)
                        {
                            resultado.AppendLine($"<i class=\"alerta_valorCups glyphicon glyphicon-warning-usd\" title=\"{registro.alertaValorNegociacion}\"></i>");
                        }
                    }
